...
const AccordionComponent = () => {
  return (
    <div>
      <Accordion collapsible type="single" className="w-full text-xl max-[1200px]:text-lg font-[Poppins] text-left">
      ...
      <AccordionItem value="item-5">
        <AccordionTrigger>Elite Cost Effectiveness</AccordionTrigger>
        <AccordionContent>
          Yes. It&apos;s animated by default, but you can disable it if you
          prefer.
        </AccordionContent>
